...
<table class="table mt-4">
    <thead>
        <tr>
            ...
            <td style="width: 12.5%; font-weight: 500;">Tipo contrato</td>
        ...
        <?php foreach ($employees as $employee) : ?>
            <tr>
                ...
                <td class="d-flex justify-content-around align-items-center">
                    ...
                    <i role="button" class="fa-regular fa-pen-to-square" data-bs-toggle="modal" data-bs-target="#edit-modal-<?= $employee['id'] ?>"></i>
                </td>
            </tr>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="stand" type="text" class="form-select form-control" required>
                                        <option <?= $employee['puesto'] == 'Asesor General' ? 'selected' : null ?>>Asesor General</option>
                                        <option <?= $employee['puesto'] == 'Auxiliar Administrativo' ? 'selected' : null ?>>Auxiliar Administrativo</option>

                                        <option <?= $employee['puesto'] == 'Tecnico' ? 'selected' : null ?>>Tecnico</option>
                                        <option <?= $employee['puesto'] == 'Loto' ? 'selected' : null ?>>Loto</option>
                                        <option <?= $employee['puesto'] == 'Irata N3' ? 'selected' : null ?>>Irata N3</option>
                                        <option <?= $employee['puesto'] == 'Lider' ? 'selected' : null ?>>Lider</option>
                                        <option <?= $employee['puesto'] == 'HSE' ? 'selected' : null ?>>HSE</option>
                                        <option <?= $employee['puesto'] == 'Irata N1' ? 'selected' : null ?>>Irata N1</option>

                                        <option <?= $employee['puesto'] == 'Apoderada Legal' ? 'selected' : null ?>>Apoderada Legal</option>
                                        <option <?= $employee['puesto'] == 'Recursos Humanos' ? 'selected' : null ?>>Recursos Humanos</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="department" type="text" class="form-select form-control" required>
                                        <option <?= $employee['departamento'] == 'Administrativo' ? 'selected' : null ?>>Administrativo</option>
                                        <option <?= $employee['departamento'] == 'Servicios' ? 'selected' : null ?>>Servicios</option>
                                        <option <?= $employee['departamento'] == 'Seguridad' ? 'selected' : null ?>>Seguridad</option>
                                    </select>
                                </div>
                                <br />
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="type-contract" type="text" class="form-select form-control" required>
                                        <option <?= $employee['tipo_contrato'] == 'Indefinido' ? 'selected' : null ?>>Indefinido</option>
                                        <option <?= $employee['tipo_contrato'] == 'Por obra' ? 'selected' : null ?>>Por obra</option>
                                    </select>
                                </div>
                                <br />
                                <div class="form-group">

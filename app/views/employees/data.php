            ...
            <form class="modal-content" action="<?= $BASE_URL ?>/data/create" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input name="starting-salary" pattern="\d+(\.\d+)?" title="Formato numerico incorrecto, solo usar punto" type="text" class="form-control" required>
                    </div>
                    <br />
                    <div class="form-group">
                        <label class="form-label">Salario diario integrado</label>
                        <input name="integrated-daily-wage" pattern="\d+(\.\d+)?" title="Formato numerico incorrecto, solo usar punto" type="text" class="form-control" required>
                    </div>
                </div>
    ...
    <div class="modal-dialog" role="document">
        <form class="modal-content" action="<?= $BASE_URL ?>/data/update" method="post">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label class="form-label">Salario inicial</label>
                    <input name="starting-salary" pattern="\d+(\.\d+)?" title="Formato numerico incorrecto, solo usar punto" type="text" class="form-control" value="<?= $personalData['salario_inicial'] ?>" required>
                </div>
                <br />
                <div class="form-group">
                    <label class="form-label">Salario inicial integrado</label>
                    <input name="integrated-daily-wage" pattern="\d+(\.\d+)?" title="Formato numerico incorrecto, solo usar punto" type="text" class="form-control" value="<?= $personalData['salario_diario_integrado'] ?>" required>
                </div>
            </div>

...
class EmployeesController extends Controller
{
    ...
    function create()
    {
        ...
        $typeContract = $_POST['type-contract'];
        $country = $_POST['country'];
        $city = $_POST['city'];
        $address = $_POST['address'];

        $this->model->insert($name, $stand, $department, $signedContract, $typeContract, $country, $city, $address);
    ...
    function update()
    {
        ...
        $this->model->update($id, $name, $stand, $department, $signedContract, $typeContract, $country, $city, $address);
